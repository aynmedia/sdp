    ...
    <div className='bg-white shadow-md rounded-lg overflow-hidden'>
      ...
      {products.featured_media && (
        <div
          ...
          style={{
            backgroundImage: `url(${products.featured_media})`,
          }}>
      ...
      {/* <div className='p-4'>
              ...
              <p className='text-3xl text-gray-900'>${product.price || '0'}</p>
        ...
        <div className='flex items-center pt-2'>
          <div>
            <p className='font-bold text-gray-900'>
              {products.title.rendered || 'Realtor not available'}
            </p>
            <p className='text-sm text-gray-700'>
              {products.realtor_phone || 'N/A'}
            </p>
          </div>
        </div>
      </div>
