    ...
    <div className='bg-primary'>
      <motion.div
        ...
        <motion.p
          ...
          Partner with us for cutting-edge pneumatic solutions tailored to your
          industry. Contact us today for personalized consultations,
      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-3 max-w-7xl mx-auto'>
        <motion.div
          ...
          <span className='my-4 block text-2xl font-bold'>
            ...
            <span className='text-[#FFD400]'>Request a call from our team</span>
          </span>
      ...
      <motion.div
        ...
        <div className='text-base font-medium text-white/30 hover:text-white flex flex-row gap-4 justify-between'>
          ...
          <span>
            Powered by{' '}
            <Link href='https://ayntech.in/' className='text-white/30 '>
              Ayn Tech Pvt. Ltd.{' '}
            </Link>
          </span>
        </div>
